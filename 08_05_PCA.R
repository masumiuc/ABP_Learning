...
pacman::p_load(GPArotation, magrittr, pacman, psych, 
  psychTools, rio, tidyverse)
# GPArotation: Gradient Projection Algorithm Rotation for FA
# magrittr: for pipes
# pacman: for loading/unloading packages
# psych: for psychometric functions
# psychTools: additional psychometric functions
...
# oblimin rotation, which is usueful for simple structure.
